<?php
	...
	class db {
		...
		function db($DBUSER, $DBPASS, $DBNAME, $DBCHARSET='NONE')
		{	    

			$this->dbh = @ibase_connect($DBNAME,$DBUSER,$DBPASS);
		...
		function select($db)
		{
			...
			else
            {
                ...
                $db=$this->db(DBUSER, DBPASS, $db, DBCHARSET);
			}
		}
		function get_blob($query) {
			$res = ibase_query($query,$this->dbh);
...
$db = new db(DBUSER, DBPASS, DBNAME, DBCHARSET);
